...
('Cardiologia', 'Reparto di Cardiologia e Unità Coronarica'),
('Radiologia', 'Diagnostica per immagini'),
('Terapia Intensiva', 'Rianimazione e Terapia Intensiva'),
('Chirurgia Generale', 'Sale operatorie chirurgia generale'),
('Laboratorio Analisi', 'Laboratorio analisi chimico-cliniche'),
('Ostetricia e Ginecologia', 'Reparto materno-infantile'),
('Pronto Soccorso', 'Emergenza e urgenza'),
('Ortopedia', 'Reparto di Ortopedia e Traumatologia'),
('Neurologia', 'Reparto di Neurologia'),
('Oculistica', 'Reparto di Oftalmologia');
